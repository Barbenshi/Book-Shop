...
function createBooks() {
    ...
    if (!books || !books.length) {
        books = []
        books.push(_createBook('Harry-Potter',30,'Pretty book about the wonders of griffindor'))
        books.push(_createBook('Lord-Of-The-Rings',30,'Extraordinary Bullshit'))
        books.push(_createBook('Life-of-Pi',30,'Simplicity'))
        for (let i = 0; i < 21; i++) {
...
function _createBook(name = makeLorem(2), price = getRandomIntInclusive(10, 20),details=makeLorem(), image = getRandomIntInclusive(1, 15)) {
    return { id: makeId(), name, price, details, rating: 0, image }
}
